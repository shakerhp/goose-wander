...
const geese: Array<GooseInfo> = [
  {
    ...
    description:
      "การออกแบบน้องจีด สายเทคนิค ซาวด์ เท่ลึก เงียบๆ เท่ๆ ชอบเสียง ดนตรี เอฟเฟกต์ จริงจังกับงานโปรดักชัน เป็นคนเบื้องหลัง แต่ขาดไม่ได้",
  ...
  },
  {
    ...
    title: "น้องจอร์ด (Jord) – The Visionary Engineer",
    description:
      "การออกแบบน้องจอร์ด ผู้นำ / นักคิด / ฝันใหญ่ ฉลาด สุขุม คิดเป็นระบบ ชอบวางแผน ทำงานเป็นหัวหน้าโปรเจค เชื่อในเทคโนโลยีและอนาคต พูดน้อย แต่ทุกคำมีน้ำหนัก",
  ...
  },
  {
    ...
    title: "จู๊ด (Jood) – The Creative Artist",
    description:
  ...
  },
  {
    ...
    title: "จืด (Jued) – Always late",
    description: "การออกแบบน้องจืด ธรรมดา ยังไม่ชัดเจน กำลังค้นหาตัวเอง เติบโตได้เสมอ เป็นมิตร เข้ากับคนง่าย ลองหลายอย่าง แต่ยังไม่เจอสิ่งที่ใช่ บางครั้งไม่มั่นใจ เปรียบเทียบตัวเองกับคนอื่น ชอบตั้งคำถามว่า “เราถนัดอะไรนะ?” แม้สับสน แต่ไม่ยอมแพ้",
